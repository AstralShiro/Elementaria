...
{
	public class AncestralSandTile : ModTile
	{
		...
		public override void SetDefaults() {
			...
			drop = ModContent.ItemType<Items.Placeable.AncestralBiome.AncestralSand>();
		...
		public override bool TileFrame(int i, int j, ref bool resetFrame, ref bool noBreak) {
			...
			if (canFall) {
				...
				int projectileType = ModContent.ProjectileType<AncestralSandProj>();
