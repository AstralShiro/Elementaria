...
namespace Elementaria.Projectiles.Melee
{
    public class Loyaltly : HeldSword
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D slash = ModContent.GetTexture("Elementaria/Textures/slash_01");
            ...
            spriteBatch.Draw(slash, pos - Main.screenPosition, null, Color.Gold * alpha, projectile.velocity.ToRotation() - MathHelper.PiOver2, slash.Size() / 2, projectile.scale / 2, SpriteEffects.None, 0f);
