...
{
	public class TacticalSniperHallow : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Tactical Sniper Rifle (Hallow)");
		}
		...
		public override void SetDefaults() {
			...
			item.shoot = ModContent.ProjectileType<TacticalSniperHallowProj>();
			item.shootSpeed = 16f;
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(ModContent.ItemType<HallowCore>(), 10);
