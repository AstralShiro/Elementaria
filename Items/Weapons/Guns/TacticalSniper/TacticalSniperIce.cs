...
{
	public class TacticalSniperIce : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Tactical Sniper Rifle (Ice)");
		}
		...
		public override void SetDefaults() {
			...
			item.shoot = ModContent.ProjectileType<TacticalSniperIceProj>();
			item.shootSpeed = 16f;
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(ModContent.ItemType<IceCore>(), 10);
