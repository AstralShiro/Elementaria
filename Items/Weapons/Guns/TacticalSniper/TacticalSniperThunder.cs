...
{
	public class TacticalSniperThunder : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Tactical Sniper Rifle (Thunder)");
		}
		...
		public override void SetDefaults() {
			...
			item.shoot = ModContent.ProjectileType<TacticalSniperThunderProj>();
			item.shootSpeed = 16f;
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(ModContent.ItemType<ThunderCore>(), 10);
