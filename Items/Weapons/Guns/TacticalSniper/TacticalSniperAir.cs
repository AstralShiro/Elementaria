...
{
	public class TacticalSniperAir : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Tactical Sniper Rifle (Air)");
		}
		...
		public override void SetDefaults() {
			...
			item.autoReuse = true;
			item.shoot = ModContent.ProjectileType<TacticalSniperAirProj>();
			item.shootSpeed = 16f;
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(ModContent.ItemType<AirCore>(), 10);
