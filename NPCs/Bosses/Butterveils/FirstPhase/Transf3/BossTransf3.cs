...
using Elementaria.NPCs.Bosses.Butterveils.FirstPhase.Transf4;
...
namespace Elementaria.NPCs.Bosses.Butterveils.FirstPhase.Transf3
{
    ...
    public class BossTransf3 : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            music = mod.GetSoundSlot(SoundType.Music, "Sounds/Music/ButterveilIce");
        ...
        {
            NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y, ModContent.NPCType<BossTransf4>(), 0, 0f, 0f, 0f, 0f);

            // Spawn 2nd Phase
            if (Main.netMode == NetmodeID.SinglePlayer) // Singleplayer
            {
                Main.NewText("You feel stuck", Color.Red);
            }
            else if (Main.netMode == NetmodeID.Server) // Server
            {
                NetMessage.BroadcastChatMessage(NetworkText.FromLiteral("You feel stuck"), Color.Red);
            }
        }
