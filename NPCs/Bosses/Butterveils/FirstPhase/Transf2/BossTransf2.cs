...
using Elementaria.NPCs.Bosses.Butterveils.FirstPhase.Transf3;

namespace Elementaria.NPCs.Bosses.Butterveils.FirstPhase.Transf2
{
    [AutoloadBossHead]
    public class BossTransf2 : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            music = mod.GetSoundSlot(SoundType.Music, "Sounds/Music/ButterveilFire");
        ...
        {
            NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y, ModContent.NPCType<BossTransf3>(), 0, 0f, 0f, 0f, 0f);

            // Spawn 2nd Phase
            if (Main.netMode == NetmodeID.SinglePlayer) // Singleplayer
            {
                Main.NewText("You feel the stuff to breathe", Color.Red);
            }
            else if (Main.netMode == NetmodeID.Server) // Server
            {
                NetMessage.BroadcastChatMessage(NetworkText.FromLiteral("You feel the stuff to breathe"), Color.Red);
            }
        }
