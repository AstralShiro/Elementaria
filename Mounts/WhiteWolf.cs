...
namespace Elementaria.Mounts
{
	public class WhiteWolf : ModMountData
	{
		...
		{
			mountData.spawnDust = ModContent.DustType<WhiteDust>();
			mountData.buff = ModContent.BuffType<WhiteWolfBuff>();
		...
		{ 
			...
			Dust.NewDust(new Vector2(rect.X, rect.Y), rect.Width, rect.Height, DustType<WhiteDust>());
		}
