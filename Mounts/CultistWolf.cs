...
namespace Elementaria.Mounts
{
	public class CultistWolf : ModMountData
	{
		...
		{
			mountData.spawnDust = ModContent.DustType<CultistDust>();
			mountData.buff = ModContent.BuffType<CultistWolfBuff>();
		...
		{ 
			...
			Dust.NewDust(new Vector2(rect.X, rect.Y), rect.Width, rect.Height, DustType<CultistDust>());
		}
